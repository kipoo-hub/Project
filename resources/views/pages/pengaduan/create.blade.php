                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('pengaduan.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                {{-- PREVIEW --}}
                                <div class="mb-2">
                                    <img id="preview-image" src="{{ asset('assets/img/placeholder.png') }}" width="180"
                                        class="rounded border" style="object-fit:cover;">
                                </div>

                                <input type="file" name="lampiran" id="lampiran"
                                    class="form-control @error('lampiran') is-invalid @enderror"
                                    accept=".jpg,.jpeg,.png,.pdf" onchange="previewLampiran(this)">
    ...
    <script>
        function previewLampiran(input) {
            ...
            // Jika file PDF
                ...
                preview.src = "{{ asset('assets/img/placeholder.png') }}";
                alert('File PDF terpilih. Preview gambar tidak tersedia.');
            }
        }
    </script>
